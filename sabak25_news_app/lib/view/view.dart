...
class _HomeViewState extends State<HomeView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: Color(0xfffe5722),
        title: const Text('News Agregator',style: TextStyle(color: Colors.white),),
        ...
        itemBuilder: (context, index){
          ...
          return InkWell(
            ...
            child: Card(
              ...
              child: Row(children: [
                Expanded(flex:3,child: Image.network(news.urlToImage ?? ApiConst.newsImage)),
